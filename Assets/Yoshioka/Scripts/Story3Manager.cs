...
public class Story3Manager : MonoBehaviour
{
    ...
    public BossKrakenController bossController;
    ...
    void Start()
    {
        ...
        if(PlayerDataManager.Instance.GetFlag("isBoss_Story3"))
        {
    ...
    public void Boss()
    {
        ...
        //Boss遭遇フラグ
        PlayerDataManager.Instance.SetFlag("isBoss_Story3",true);
    }
    ...
    public void AfterBoss()
    {
        ...
        PlayerDataManager.Instance.SetFlag("isBoss_Story3",false);
        PlayerDataManager.Instance.SetFlag("isClear_Story3",true);
    }
    ...
    {
        PlayerDataManager.Instance.SetFlag("isBoss_Story3",false);
        LoadingManager.Instance.LoadScene("Story3",2.0f);
    }
    ...
    {
        LoadingManager.Instance.LoadScene("Story3",1.9f);
    }
}
