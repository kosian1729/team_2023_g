...
public class MiniMachineController2 : MonoBehaviour, IDamagable
{
    [Header("敵のスピード")]
    [Tooltip("標準値は1です。")]
    ...
    void Update()
    {
        ...
        {
            Instantiate(bullet,this.transform.position,Quaternion.Euler(0,0,Random.Range(90.5f,97.0f)));
            Instantiate(bullet,this.transform.position,Quaternion.Euler(0,0,Random.Range(82.0f,89.5f)));
